...
namespace shanuMVCUserRoles.Controllers
{
    ...
    public class AspNetUsersController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Email,EmailConfirmed,PasswordHash,SecurityStamp,PhoneNumber,PhoneNumberConfirmed,TwoFactorEnabled,LockoutEndDateUtc,LockoutEnabled,AccessFailedCount,UserName,Ime,Prezime,Adresa")] AspNetUser aspNetUser)
        {
            if (ModelState.IsValid)
            {
